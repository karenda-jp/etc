...
> [!WARNING]
> 2026-04-03 16:00～　Youtubeの仕様変更で公開中のmylistを利用出来ません.
> ERROR --> "reason":"ログインして bot ではないことを確認してください"
> 15時28分ごろに大量リクエストを行ったユーザーが原因によるIP-BANです(泣)
...
### tverの番組表、信じないで下さい。15時間放送とかなってるけど修正不能です　↑
### 仕様に抗えない運命 :)
