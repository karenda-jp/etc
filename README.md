...
2026/06/02　ひとりごつ～
6月になり、いつもの定期更新をやろうとEPGデータ取得を実行するとIPx(ba?gumi.org)のサイトでエラー発生
2パターン取得用意してあり、自分の中でいう旧型を使い成功したので急遽差し替えて対応しました。
この旧型はたった5ｃｈ分しか使わないデータも一気に全ｃｈ/日数取り寄せてからじゃないと使えないから使い勝手は悪い・・・。
...
~~~
 ...
 ・ Youtube_mylist.m3u8 ⇒ Youtubeの番組をIPTVとして観れたらどうだ？実験的ファイル リスト内の説明を読む事！
      ↑　2026-06-01 ここ数日、たまにエラー吐いてます。エラーが出たら１時間はずっとエラーですよー。
...
> [!WARNING]
> Youtube_mylistについて <br />
> 2026-05-19 19:20～　Youtube_mylistのアドレスを変更しました。<br />
>「**2026-05-19 19:20～ 障害対応の結果 動画再生モード削除**」<br />
> 個人開発の限界を感じており、実は独自のphpプログラムで実現しています。<br />
> 現段階の極限まで要約したphpソースコードを公開し、次回の不具合で公開の終了を予定しています。<br />
> 不具合内容を特定して対処まで実に数時間掛かっている経緯をご理解下さい。<br />
> [0520-YT.zip(YoutubeLive配信のm3u8を取るphp)](https://drive.google.com/file/d/1CrvYSloK3X8duhVd5qszBe1VOBvDUBQD/view) <br />
> 
> <br />
